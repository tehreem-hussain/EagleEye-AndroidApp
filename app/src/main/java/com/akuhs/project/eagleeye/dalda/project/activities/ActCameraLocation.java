...
public class ActCameraLocation extends AppCompatActivity {
    ...
    private Context ctx = ActCameraLocation.this;
    private Uri fileUri;
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(ActCameraLocation.this, REQUEST_CHECK_SETTINGS);
