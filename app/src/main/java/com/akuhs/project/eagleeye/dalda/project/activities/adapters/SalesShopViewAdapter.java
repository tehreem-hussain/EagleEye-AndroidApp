...
public class SalesShopViewAdapter extends RecyclerView.Adapter<SalesShopViewAdapter.ShopHolder> {
    List<GetSalesShopResponse> list;

    public SalesShopViewAdapter(List<GetSalesShopResponse> list) {
...
//
        ...
        holder.llViewShop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(v.getContext(), ActUpdateStockPosition.class);
